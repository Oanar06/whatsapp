...
class _LoginPageState extends ConsumerState<LoginPage> {
  ...
  sendCodeToPhone() {
    final phoneNumder = phoneNumberController.text;
    final countryName = countryNameController;
    final countryCode = countryCodeController;
    if (phoneNumder.isEmpty) {
      return showAlertDialog(
        context: context,
        message: 'Please enter your phone number',
      );
    } else if (phoneNumder.length < 9) {
      return showAlertDialog(
        context: context,
        message:
            "The phone number you entered is too short for the country: $countryName.\n\nInclude your area code if you haven't ",
      );
    } else if (phoneNumder.length > 10) {
      return showAlertDialog(
        context: context,
        message:
    ...
    ref.read(authControllerProvider).sendSmsCode(
          context: context,
          phoneNumber: '+$countryCode$phoneNumder',
        );
  }
        ...
        children: [
          Padding(
            ...
            child: RichText(
                ...
                text: TextSpan(
                    text: 'WhatsApp will need to verfy your phone number.',
                    style: TextStyle(
